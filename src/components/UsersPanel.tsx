      ...
      <div>
        <div className="bg-cyan-50 border border-cyan-200 rounded-xl p-3 flex items-start gap-2.5 mb-3">
          ...
          <p className="text-xs text-cyan-900">
            Comptes créés via l'espace participant (/investor). Les comptes admin individuels (rôles Owner/Admin/
            Manager/Employee) ne sont pas encore mis en place — l'admin utilise toujours le mot de passe partagé.
          </p>
        </div>
